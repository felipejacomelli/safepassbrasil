  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-foreground">Carregando configurações...</div>
      </div>
    )
  }
          ...
          <Card className="bg-card border-zinc-800">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="siteUrl" className="text-foreground">URL do Site</Label>
                  <Input
                    id="siteUrl"
              ...
              <div className="space-y-2">
                <Label htmlFor="siteDescription" className="text-foreground">Descrição do Site</Label>
                <Textarea
                  id="siteDescription"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="adminEmail" className="text-foreground">Email do Administrador</Label>
                  <Input
                    id="adminEmail"
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="defaultLanguage" className="text-foreground">Idioma Padrão</Label>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">Desabilita o acesso público à plataforma</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <Label className="text-foreground">Registro de Usuários</Label>
                    <p className="text-sm text-muted-foreground">Permite novos cadastros na plataforma</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <Label className="text-foreground">Verificação de Email</Label>
        ...
        <TabsContent value="email" className="space-y-6">
          <Card className="bg-card border-zinc-800">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="smtpHost" className="text-foreground">Servidor SMTP</Label>
                  <Input
                    id="smtpHost"
                ...
                <div className="space-y-2">
                  <Label htmlFor="smtpPort" className="text-foreground">Porta SMTP</Label>
                  <Input
                    id="smtpPort"
                    type="number"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="smtpUsername" className="text-foreground">Usuário SMTP</Label>
                  <Input
                    id="smtpUsername"
                ...
                <div className="space-y-2">
                  <Label htmlFor="smtpPassword" className="text-foreground">Senha SMTP</Label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="fromEmail" className="text-foreground">Email Remetente</Label>
                  <Input
                    id="fromEmail"
                    type="email"
                ...
                <div className="space-y-2">
                  <Label htmlFor="fromName" className="text-foreground">Nome Remetente</Label>
                  <Input
                    id="fromName"
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Permite o envio de emails pela plataforma</p>
                </div>
                <Switch
          ...
          <Card className="bg-card border-zinc-800">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <Label className="text-foreground">PIX</Label>
                    <p className="text-sm text-muted-foreground">Pagamentos via PIX</p>
                  </div>
                  <Switch
              ...
              {/* Limites */}
              <div className="space-y-4">
                <h4 className="text-foreground font-medium">Limites de Transação</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="minimumAmount" className="text-foreground">Valor Mínimo (R$)</Label>
                    <Input
                      id="minimumAmount"
                      type="number"
                      step="0.01"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="maximumAmount" className="text-foreground">Valor Máximo (R$)</Label>
                    <Input
                      id="maximumAmount"
                      type="number"
                      step="0.01"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="processingFee" className="text-foreground">Taxa de Processamento (%)</Label>
                    <Input
                      id="processingFee"
                      type="number"
                      step="0.1"
        ...
        <TabsContent value="security" className="space-y-6">
          <Card className="bg-card border-zinc-800">
            ...
            <CardContent className="space-y-6">
              {/* Password Policy */}
              <div className="space-y-4">
                <h4 className="text-foreground font-medium">Política de Senhas</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="passwordMinLength" className="text-foreground">Comprimento Mínimo</Label>
                    <Input
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-foreground">Exigir Caracteres Especiais</Label>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <Label className="text-foreground">Exigir Números</Label>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <Label className="text-foreground">Exigir Maiúsculas</Label>
                    <Switch
              ...
              {/* Session & Login */}
              <div className="space-y-4">
                <h4 className="text-foreground font-medium">Sessão e Login</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="sessionTimeout" className="text-foreground">Timeout da Sessão (min)</Label>
                    <Input
                      id="sessionTimeout"
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="maxLoginAttempts" className="text-foreground">Máx. Tentativas de Login</Label>
                    <Input
                      id="maxLoginAttempts"
                      type="number"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="lockoutDuration" className="text-foreground">Duração do Bloqueio (min)</Label>
                    <Input
                      id="lockoutDuration"
                      type="number"
              ...
              {/* API Rate Limiting */}
              <div className="space-y-4">
                <h4 className="text-foreground font-medium">Limitação de API</h4>
                <div className="space-y-2">
                  <Label htmlFor="apiRateLimit" className="text-foreground">Limite de Requisições por Minuto</Label>
                  <Input
                    id="apiRateLimit"
                    type="number"
